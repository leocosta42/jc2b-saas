...
-- Migration 008: Campos de Frete no Pedido
ALTER TABLE pedidos
  ADD COLUMN IF NOT EXISTS valor_frete DECIMAL(12,2) DEFAULT 0,
  ADD COLUMN IF NOT EXISTS peso_total DECIMAL(10,3) DEFAULT 0;

-- Migration 009: Adicionar campo bloqueado
ALTER TABLE clientes ADD COLUMN IF NOT EXISTS bloqueado BOOLEAN DEFAULT false;
ALTER TABLE fornecedores ADD COLUMN IF NOT EXISTS bloqueado BOOLEAN DEFAULT false;
